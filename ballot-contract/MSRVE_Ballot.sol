...
contract MSRVE_Ballot {
    ...
    function register() public validPhase(Phase.Regs) {
        ...
        require (voters[msg.sender].weight == 0);   // So that func can run once per user.
    ...
    function reqWinner() public validPhase(Phase.Done) returns (uint256 ) {
        ...
        // This function is a stub and is yet to be written on account of requirement of multiple loops. 

        // Only zero is returned for now.
